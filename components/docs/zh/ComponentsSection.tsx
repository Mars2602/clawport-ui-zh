    ...
    SettingsProvider (app/settings-provider.tsx)
      ...
      <InfoCard title="ThemeProvider">
        <BulletList
          items={[
            ...
            "管理活动主题并通过 data-theme 属性应用到 <html>",
            <>
              消费者 hook：{" "}
      ...
      <Table
        ...
        rows={[
          ...
          [
            "AgentList",
            "聊天的代理选择侧边栏。桌面端（固定 300px）和移动端（全宽）变体。",
          ],
          [
            "VoiceMessage",
      ...
      <Table
        ...
        rows={[
          [
            "OrgMap",
            "React Flow 组织图，带基于 BFS 的层级布局、边高亮和交互式缩放。",
          ],
          [
            "AgentNode",
            "自定义 React Flow 节点：头像、名称、标题、代理健康指示器、选择状态。",
          ],
          [
            "GridView",
      ...
      <Table
        ...
        rows={[
          [
            "KanbanBoard",
            "四列看板（待处理、进行中、审查、已完成），带代理筛选器。",
          ],
          [
            "KanbanColumn",
            "单列，带 HTML5 拖放支持和放置区域高亮。",
          ],
          [
            "TicketCard",
            "可拖动卡片：优先级点、标题、代理头像、工作状态指示器。",
          ],
          [
            "TicketDetailPanel",
            "滑入侧边栏面板，用于工单详情和内联代理聊天。",
          ],
          [
            "CreateTicketModal",
            "用于创建工单的模态框，包含标题、描述、优先级、代理分配。",
          ],
        ]}
      />
      ...
      <Table
        ...
        rows={[
          [
            "OnboardingWizard",
            "5 步首次运行设置向导（名称、主题、强调色、语音、概览）。可从设置页面重新运行。",
          ],
          [
            "AgentAvatar",
            "代理头像：头像图片、彩色背景上的 emoji 或仅 emoji 模式。",
          ],
          [
            "DynamicFavicon",
            "使用 Canvas API 从门户 emoji/icon 生成 favicon。",
          ],
          [
            "ErrorState",
            "带可选重试按钮的全屏错误显示。",
      ...
      <Paragraph>
        <InlineCode>components/ui/</InlineCode> 中的 Radix 基础原语组件（shadcn/ui 风格包装器）：
      </Paragraph>
      <BulletList
        items={[
